...
let pieces = {
    whiteRook1: {side: 'w',cords: [8, 1],class: 'rook',img: 'whiteRook.png',name: 'whiteRook1',},
    whiteRook2: {side: 'w',cords: [1, 1],class: 'rook',img: 'whiteRook.png',name: 'whiteRook2',},
    whiteBishop1: {side: 'w',cords: [3, 1],class: 'bishop',img: 'whiteBishop.png',name: 'whiteBishop1',},
    whiteBishop2: {side: 'w',cords: [6, 1],class: 'bishop',img: 'whiteBishop.png',name: 'whiteBishop2',},
    blackBishop1: {side: 'b',cords: [6, 8],class: 'bishop',img: 'blackBishop.png',name: 'blackBishop1',},
    blackBishop2: {side: 'b',cords: [3, 8],class: 'bishop',img: 'blackBishop.png',name: 'blackBishop2',},
    blackRook1: {side: 'b',cords: [1, 8],class: 'rook',img: 'blackRook.png',name: 'blackRook1',},
    blackRook2: {side: 'b',cords: [8, 8],class: 'rook',img: 'blackRook.png',name: 'blackRook2',},
    whiteQueen: {side: 'w',cords: [4, 1],class: 'queen',img: 'whiteQueen.png',name: 'whiteQueen',},
    blackQueen: {side: 'b',cords: [4, 8],class: 'queen',img: 'blackQueen.png',name: 'blackQueen',},
    whiteKnight1: {side: 'w',cords: [2, 1],class: 'knight',img: 'whiteKnight.png',name: 'whiteKnight1',},
    whiteKnight2: {side: 'w',cords: [7, 1],class: 'knight',img: 'whiteKnight.png',name: 'whiteKnight2',},
    blackKnight1: {side: 'b',cords: [2, 8],class: 'knight',img: 'blackKnight.png',name: 'blackKnight1',},
    blackKnight2: {side: 'b',cords: [7, 8],class: 'knight',img: 'blackKnight.png',name: 'blackKnight2',},
    whiteKing: {side: 'w',cords: [5, 1],class: 'king',img: 'whiteKing.png',name: 'whiteKing',},
    blackKing: {side: 'b',cords: [5, 8],class: 'king',img: 'blackKing.png',name: 'blackKing',},
    whitePawn1: { side: 'w', cords: [1, 2], class: 'pawn', img: 'whitePawn.png', name: 'whitePawn1',},
    whitePawn2: { side: 'w', cords: [2, 2], class: 'pawn', img: 'whitePawn.png', name: 'whitePawn2',},
    whitePawn3: { side: 'w', cords: [3, 2], class: 'pawn', img: 'whitePawn.png', name: 'whitePawn3',},
    whitePawn4: { side: 'w', cords: [4, 2], class: 'pawn', img: 'whitePawn.png', name: 'whitePawn4',},
    whitePawn5: { side: 'w', cords: [5, 2], class: 'pawn', img: 'whitePawn.png', name: 'whitePawn5',},
    whitePawn6: { side: 'w', cords: [6, 2], class: 'pawn', img: 'whitePawn.png', name: 'whitePawn6',},
    whitePawn7: { side: 'w', cords: [7, 2], class: 'pawn', img: 'whitePawn.png', name: 'whitePawn7',},
    whitePawn8: { side: 'w', cords: [8, 2], class: 'pawn', img: 'whitePawn.png', name: 'whitePawn8',},
    blackPawn1: { side: 'b', cords: [1, 7], class: 'pawn', img: 'blackPawn.png', name: 'blackPawn1',},
    blackPawn2: { side: 'b', cords: [2, 7], class: 'pawn', img: 'blackPawn.png', name: 'blackPawn2',},
    blackPawn3: { side: 'b', cords: [3, 7], class: 'pawn', img: 'blackPawn.png', name: 'blackPawn3',},
    blackPawn4: { side: 'b', cords: [4, 7], class: 'pawn', img: 'blackPawn.png', name: 'blackPawn4',},
    blackPawn5: { side: 'b', cords: [5, 7], class: 'pawn', img: 'blackPawn.png', name: 'blackPawn5',},
    blackPawn6: { side: 'b', cords: [6, 7], class: 'pawn', img: 'blackPawn.png', name: 'blackPawn6',},
    blackPawn7: { side: 'b', cords: [7, 7], class: 'pawn', img: 'blackPawn.png', name: 'blackPawn7',},
    blackPawn8: { side: 'b', cords: [8, 7], class: 'pawn', img: 'blackPawn.png', name: 'blackPawn8',},
}
